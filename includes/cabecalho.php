    ...
    <div style="display:flex;justify-content:flex-end;align-items:center;background:#2c3e50;padding:10px 20px;">
      <div style="position:relative;"
        ...
        <div style="cursor:pointer;display:flex;align-items:center;">
          ...
          <span style="color:white;margin-left:10px;">Giovana</span>
        </div>

        <div class="dropdown" style="display:none;position:fixed;top:60px;right:20px;background:#fff;min-width:160px;border:1px solid #ccc;border-radius:4px;box-shadow:0 4px 6px rgba(0,0,0,0.1);z-index:9999;">
          <a href="#" style="display:block;padding:10px 15px;text-decoration:none;color:#000;">Editar Perfil</a>
